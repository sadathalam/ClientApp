...
public class UIEmployee extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        InstructorUI ui = new InstructorUI();
        ui.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            // TODO add your handling code here:
            String employeeNum = JOptionPane.showInputDialog("Employee Number");
            Statement stmt = con.createStatement();
            String delete = "DELETE FROM EMPLOYEE where EMPLOYEE_ID = " + employeeNum;
            stmt.execute(delete);
